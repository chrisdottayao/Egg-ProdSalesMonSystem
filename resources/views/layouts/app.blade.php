    ...
    <aside class="fixed left-0 top-16 bottom-0 w-64 bg-white border-r border-gray-200 z-20 transition-transform duration-300"
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="{{ route('expenses.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('expenses.*') ? 'bg-[#4CAF50] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3v-3m-3 3v-3m10-8V6a2 2 0 00-2-2H6a2 2 0 00-2 2v13a2 2 0 002 2h4m6-6h.01M5 20h14a2 2 0 002-2v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2z"/></svg>
                <span>Expenses</span>
            </a>
            ...
            <a href="{{ route('daily-entry.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('daily-entry.*') ? 'bg-[#4CAF50] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 12h6m-6 4h6"/></svg>
                <span>Daily Entry</span>
            </a>

            <a href="{{ route('flock-records.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('flock-records.*') ? 'bg-[#4CAF50] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                <span>Flock Records</span>
            </a>

            @if(in_array(Auth::user()->role, ['admin', 'manager']))
            <a href="{{ route('investment.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('investment.*') ? 'bg-[#4CAF50] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18M9 17V9m4 8V5m4 12v-6"/></svg>
            ...
            <a href="{{ route('settings.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('settings.*') ? 'bg-[#4CAF50] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
